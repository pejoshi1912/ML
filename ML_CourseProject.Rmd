...
```{r}
library(ipred)
rpart.plot::prp(fit$finalModel,box.palette="Red",tweak = 1.5)
```

##Predictions

Using our dicision tree model we will predict classes  for all the test cases.

```{r}
result <- predict(fit, testPCASet)
result
